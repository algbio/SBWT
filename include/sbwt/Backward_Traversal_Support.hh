...
// Only works for the plain matrix variant
...
class Backward_Traversal_Support{

    private:

        // No copying because of pointer business
        Backward_Traversal_Support(Backward_Traversal_Support const& other) = delete;
        Backward_Traversal_Support(Backward_Traversal_Support&) = default;
    ...
    public:
        ...
        Backward_Traversal_Support() {}
        Backward_Traversal_Support(const plain_matrix_sbwt_t* SBWT) : SBWT(SBWT){
